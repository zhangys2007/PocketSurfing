...
- (void)defaultSettings
{
    ...
    self.heightOfTabView = K_heightOfTabView;

    self.yPositionOfTabView = 0;
...
- (void)defaultSetUp
{
    ...
    if (!self.contentView) {
        ...
        if ([self.delegate respondsToSelector:@selector(viewPagerDidAddContentView)]) {
            ...
            [self.view addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-35-[contentView]-0-|" options:0 metrics:nil views:views]];
        }
    }
