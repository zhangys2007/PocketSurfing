...
#define DEFAULT_TEXT_FONT                   [UIFont systemFontOfSize:SCREEN_AUTO_SIZE 14.0f]
...
#define DEFAULT_SEGMENT_EDGE_INSET          UIEdgeInsetsMake(SCREEN_AUTO_SIZE 5, SCREEN_AUTO_SIZE 5, SCREEN_AUTO_SIZE 5, SCREEN_AUTO_SIZE 5);
#define DEFAULT_BOX_BACKGROUND_COLOR_ALPHA  0.2f;
#define DEFAULT_BOX_BORDER_COLOR_ALPHA      0.3f
#define DEFAULT_BOX_BORDER_WIDTH            SCREEN_AUTO_SIZE 1.0f;
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _backgroundColor = [UIColor colorWithRed:240 / 255.0 green:239 / 255.0 blue:240 / 255.0 alpha:1.0];

        _textFont = DEFAULT_TEXT_FONT;
        _textColor = DEFAULT_TEXT_COLOR;

        _selectedTextColor = [UIColor colorWithRed:255 / 255.0 green:0 / 255.0 blue:100 / 255.0 alpha:1];

        _textAlignment = SMVerticalSegmentedControlTextAlignmentCenter;

        _selectionIndicatorColor = [UIColor colorWithRed:240 / 255.0 green:80 / 255.0 blue:70 / 255.0 alpha:1.0];
        ...
        _selectionLocation = SMVerticalSegmentedControlSelectionLocationRight;

        _segmentEdgeInset = DEFAULT_SEGMENT_EDGE_INSET;

        _width = SCREEN_AUTO_SIZE kDefaultSegmentWidth;
...
- (CGRect)frameForSelectionIndicator
{
    ...
    if (self.selectionStyle == SMVerticalSegmentedControlSelectionStyleTextHeightStrip && sectionHeight <= self.segmentHeight) {
        ...
        return CGRectMake(indicatorXOffset, y - SCREEN_AUTO_SIZE 5, self.selectionIndicatorThickness, sectionHeight + SCREEN_AUTO_SIZE 10);
    } else {
