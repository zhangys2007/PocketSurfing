...
@interface WorthToBuyCollectionVC ()
@property(nonatomic, retain)NSMutableArray * dataArray;
@property(nonatomic, retain)NSMutableArray * likeDataArray;
@end

@implementation WorthToBuyCollectionVC
- (void)dealloc
{
    self.dataArray = nil;
...
-(void)loadNewData
{
    [self loadDataWithPage:_pageCount];
}
...
-(void)loadDataWithPage:(NSInteger)pageNumber
{
    ...
    [netWork get:[NSString stringWithFormat:@"http://jkjby.yijia.com/jkjby/view/tmzk19_9_api.php?cid=%ld",(long)pageNumber]];
}
